...
class AbusiveCommentClassifier(nn.Module):
    """
    Abusive Comment Classifier using XLM-RoBERTa with multi-head attention and deep classification layers.
    ...
    def __init__(self, model_name='xlm-roberta-base', num_classes=2, dropout_rate=0.3):
        super(AbusiveCommentClassifier, self).__init__()
